...
VALUES (
'$gidcsession',  '$gmodelo',  '$glayout',  '$gposicao',  'https://www.case3d.com.br/case3d/$gimagem2',  '$qnheight',  '$qnwidth',  '$qnleft',  '$qntop'
)
";
...
if (!$result) {
    ...
    ?>
        <img src="https://www.case3d.com.br/case3d/<?php echo "$novoarq"; ?>.png">
        <img src="https://www.case3d.com.br/case3d/<?php echo "$novoarq"; ?>.png-40.png">
        <img src="https://www.case3d.com.br/case3d/<?php echo "$novoarq"; ?>.png-pb.png">
        <img src="https://www.case3d.com.br/case3d/<?php echo "$novoarq"; ?>.png-sp.png">
    <?php
}
