...
background-color: transparent;
  ...
  <title>case3d - Monte sua capinha</title>
  ...
  <script type="text/javascript">
    ...
    function p4concluir() {
      ...
      document.getElementById("frcompletar").src = "https://www.case3d.com.br/case3d/3/index.php?idcsession=<?php echo $idcsession; ?>&m="+document.getElementById("modelodocelular").value+"&l="+document.getElementById("layoutdacapinha").value;
    }
    ...
    function showfacebook() {
      document.getElementById("frcompupload").src = "https://www.case3d.com.br/case3dapp/1/index.php?m="+document.getElementById("modelodocelular").value+"&l="+document.getElementById("layoutdacapinha").value;
    ...
    function showinstagram() {
      document.getElementById("frcompupload").src = "https://www.case3d.com.br/instagramcdapp/instagram/1/?m="+document.getElementById("modelodocelular").value+"&l="+document.getElementById("layoutdacapinha").value;
    ...
    function showcomputador() {
      document.getElementById("frcompupload").src = "https://www.case3d.com.br/case3d/4/?m="+document.getElementById("modelodocelular").value+"&l="+document.getElementById("layoutdacapinha").value;
...
Layout 1: 1 foto; <br />Layout 2: 2 fotos; <br />Layout 3: 15 fotos
  ...
  <div>
	...
	<a href="#" onclick="p4concluir()"><img src="/case3d/0/img/btconcluido.png" alt=""></a>
    </div>
