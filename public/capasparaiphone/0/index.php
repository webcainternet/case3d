...
background-color: transparent;
  ...
  <script type="text/javascript">
    ...
    function p4concluir() {
      ...
      document.getElementById("frcompletar").src = "https://www.capasparaiphone.com.br/capasparaiphone/3/index.php?idcsession=<?php echo $idcsession; ?>&m="+document.getElementById("modelodocelular").value+"&l="+document.getElementById("layoutdacapinha").value;
    }
    ...
    function showfacebook() {
      document.getElementById("frcompupload").src = "https://www.capasparaiphone.com.br/capasparaiphoneapp/1/index.php?m="+document.getElementById("modelodocelular").value+"&l="+document.getElementById("layoutdacapinha").value;
    ...
    function showinstagram() {
      document.getElementById("frcompupload").src = "https://www.capasparaiphone.com.br/instagramcpiapp/instagram/1/?m="+document.getElementById("modelodocelular").value+"&l="+document.getElementById("layoutdacapinha").value;
    ...
    function showcomputador() {
      document.getElementById("frcompupload").src = "https://www.capasparaiphone.com.br/capasparaiphone/4/?m="+document.getElementById("modelodocelular").value+"&l="+document.getElementById("layoutdacapinha").value;
