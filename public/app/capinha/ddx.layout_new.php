...
<?php //Layout 1 Foto
    if ($layout == 0) { ?>
        <div class="bordapontilhada">
            <div id="divmask" style="padding: 0px; height: <?php echo $alturatotal; ?>px; width: <?php echo $larguratotal; ?>px; margin-left: 0px; background-image: url(https://case3d.com.br/app/img/<?php echo $mimage; ?>); background-repeat: no-repeat no-repeat;">
