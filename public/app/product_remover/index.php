...
<?php
	...
	if ($glayout == 0) {
        ...
        $sqlangulo1 = "SELECT * FROM oc_capasconstrucao_girar WHERE idsession = $gidcsession AND posicao = 1 limit 1;";
...
<!-- FIM LAYOUT 2 -->
                ...
                $sqlangulo2 = "SELECT * FROM oc_capasconstrucao_girar WHERE idsession = $gidcsession AND posicao = 2 limit 1;";
        ...
        if ($glayout == 2) {
            ...
            <?php
                ...
                $sql_statement9  = "SELECT * FROM oc_capasconstrucao WHERE idcsession = $gidcsession AND modelo = $gmodelo AND layout = $glayout AND posicao = 9  order by datainsert desc limit 1";
                ...
                $sql_statement10  = "SELECT * FROM oc_capasconstrucao WHERE idcsession = $gidcsession AND modelo = $gmodelo AND layout = $glayout AND posicao = 10  order by datainsert desc limit 1";
                ...
                $sql_statement11  = "SELECT * FROM oc_capasconstrucao WHERE idcsession = $gidcsession AND modelo = $gmodelo AND layout = $glayout AND posicao = 11  order by datainsert desc limit 1";
                ...
                $sql_statement12  = "SELECT * FROM oc_capasconstrucao WHERE idcsession = $gidcsession AND modelo = $gmodelo AND layout = $glayout AND posicao = 12  order by datainsert desc limit 1";
                ...
                $sql_statement13  = "SELECT * FROM oc_capasconstrucao WHERE idcsession = $gidcsession AND modelo = $gmodelo AND layout = $glayout AND posicao = 13  order by datainsert desc limit 1";
                ...
                $sql_statement14  = "SELECT * FROM oc_capasconstrucao WHERE idcsession = $gidcsession AND modelo = $gmodelo AND layout = $glayout AND posicao = 14  order by datainsert desc limit 1";
                ...
                $sql_statement15  = "SELECT * FROM oc_capasconstrucao WHERE idcsession = $gidcsession AND modelo = $gmodelo AND layout = $glayout AND posicao = 15  order by datainsert desc limit 1";
...
<!-- Mascaras -->
<?php if ($_GET["m"] == "0") { ?>
<div style="position: absolute; top: 0px; left: 0px; margin-left: 10px; padding: 0px; height: 494px; width: 340px; background-size: 340px; background-image: url(https://case3d.com.br/app/img/mask-iphone4-top.png); background-repeat: no-repeat no-repeat;">&nbsp;</div>
<? } ?>

<?php if ($_GET["m"] == "1") { ?>
<div style="position: absolute; top: 0px; left: 0px; margin-left: 10px; padding: 0px; height: 542px; width: 340px; background-size: 340px; background-image: url(https://case3d.com.br/app/img/mask-iphone5-top.png); background-repeat: no-repeat no-repeat;">&nbsp;</div>
<? } ?>

<?php if ($_GET["m"] == "2") { ?>
<div style="position: absolute; top: 0px; left: 0px; margin-left: 10px; padding: 0px; height: 531px; width: 340px; background-size: 340px; background-image: url(https://case3d.com.br/app/img/mask-galaxy3-top.png); background-repeat: no-repeat no-repeat;">&nbsp;</div>
<? } ?>

<?php if ($_GET["m"] == "3") { ?>
<div style="position: absolute; top: 0px; left: 0px; margin-left: 10px; padding: 0px; height: 503px; width: 340px; background-size: 340px; background-image: url(https://case3d.com.br/app/img/mask-galaxy4-top.png); background-repeat: no-repeat no-repeat;">&nbsp;</div>
<? } ?>

<?php if ($_GET["m"] == "4") { ?>
<div style="position: absolute; top: 0px; left: 0px; margin-left: 10px; padding: 0px; height: 563px; width: 343px; background-size: 340px; background-image: url(https://case3d.com.br/app/img/mask-galaxys2-top.png);">&nbsp;</div>
<? } ?>

<?php if ($_GET["m"] == "5") { ?>
<div style="position: absolute; top: 0px; left: 0px; margin-left: 10px; padding: 0px; height: 564px; width: 343px; background-size: 340px; background-image: url(https://case3d.com.br/app/img/mask-galaxyn2-top.png);">&nbsp;</div>
<? } ?>
