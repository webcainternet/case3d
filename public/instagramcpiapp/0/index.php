...
font-family: "Minha Fonte2", Arial, Verdana;
  ...
  <script type="text/javascript">
    ...
    function showfacebook() {
      window.parent.document.getElementById("frcompupload").src = "https://www.capasparaiphone.com.br/capasparaiphoneapp/1/?m="+document.getElementById("modelodocelular").value+"&l="+document.getElementById("layoutdacapinha").value;
    ...
    function showcomputador() {
      window.parent.document.getElementById("frcompupload").src = "https://www.capasparaiphone.com.br/capasparaiphone/1/?m="+document.getElementById("modelodocelular").value+"&l="+document.getElementById("layoutdacapinha").value;
